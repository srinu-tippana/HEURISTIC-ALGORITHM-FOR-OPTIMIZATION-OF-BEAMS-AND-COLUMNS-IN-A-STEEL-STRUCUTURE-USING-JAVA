 ...
 * @author Cnu
 */
public class SAP2000ALGORITHM1 {
    ...
    public static void main(String[] args) 
    {
       ...
       // System.out.println(b.length);
        ...
        boolean set=true;
        int count=0;
        int[] se = SAP2000ALGORITHM1.decrease(beam,outer_column,inner_column);
        ...
        while(count!=3)
        {
            ...
            if(status==1)
            {
                ...
                if(array_code==1)// this means one element is present 
                {
                    ...
                    se=SAP2000ALGORITHM1.decrease(value1,value2,value3);
                }
            ...
            else
            {
               ...
               se=SAP2000ALGORITHM1.increase(value1,value2,value3); 
        ...
        System.out.println("the ffinal accepted list after 1st iteration is ");
        for(int i=0;i<1;i++)
        {
            System.out.println(accepted[i]);
            System.out.println(accepted1[i]);
            System.out.println(accepted2[i]);
        }
        int seccount=0;
        ...
        se=SAP2000ALGORITHM1.decrease(se[0],se[1],se[2]);
         while(seccount!=3)
        {
             int value1 =se[0],value2=se[1],value3=se[2];
            System.out.println("did"+" "+value1+" "+value2+" "+value3+" "+" passs SAP ANALYSIS");
